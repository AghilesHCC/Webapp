...
export const ESPACE_TYPE_OPTIONS = [
  ...
  { value: ESPACE_TYPES.SALLE_REUNION, label: ESPACE_TYPE_LABELS[ESPACE_TYPES.SALLE_REUNION] },
  { value: ESPACE_TYPES.POSTE_INFORMATIQUE, label: ESPACE_TYPE_LABELS[ESPACE_TYPES.POSTE_INFORMATIQUE] }
]
